...
rating_df = load_rating('../unsupervised_data/unsupervised_movie_data/train.csv')
movie = load_movie('../unsupervised_data/unsupervised_movie_data/movies.csv')
# test = load_movie('../unsupervised_data/unsupervised_movie_data/test.csv').head(100000)
